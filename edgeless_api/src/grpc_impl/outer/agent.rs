...
impl AgentAPIClient {
    pub fn new(api_addr: &str, tls_config: Option<crate::grpc_impl::tls_config::TlsConfig>) -> Self {
        Self {
            ...
            >::new(api_addr.to_string(), tls_config.clone())),
            node_management_client: Box::new(crate::grpc_impl::inner::node_management::NodeManagementClient::new(
                api_addr.to_string(),
                tls_config.clone(),
            )),
